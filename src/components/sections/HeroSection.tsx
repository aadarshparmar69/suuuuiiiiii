...
export const HeroSection = () => {
  ...
  return <section ref={heroRef} className="relative min-h-[90vh] flex items-center justify-center pt-24 pb-16 lg:pt-32 lg:pb-24 overflow-hidden">
      {/* Refined Background */}
      <div className="absolute inset-0 overflow-hidden">
        ...
        ease: "easeOut"
          ...
          <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full h-[70%]" style={{
          background: `radial-gradient(ellipse 80% 60% at 50% 20%, hsl(var(--primary) / 0.12) 0%, transparent 70%)`
        }} />
          
          {/* Secondary subtle accent */}
          <motion.div className="absolute top-1/3 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[400px] md:w-[900px] md:h-[600px]" animate={{
          scale: [1, 1.02, 1],
          opacity: [0.8, 1, 0.8]
        }} transition={{
          duration: 8,
      ...
      <div className="container mx-auto px-4 lg:px-8 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          delay: 0.6
            ...
            <Link to="/use-cases" className="text-sm text-muted-foreground hover:text-foreground transition-colors flex items-center gap-1 group">
              ​View Use Cases  
