...
export const HeroSection = () => {
  ...
  return (
    <section
      ref={heroRef}
      className="relative min-h-[100vh] flex items-center justify-center pt-20 pb-20 lg:pt-28 lg:pb-28 overflow-hidden"
    >
      ...
      >
        ...
        >
          ...
          <div
            className="absolute top-0 left-1/2 -translate-x-1/2 w-full h-[85%]"
            style={{
          ...
          <motion.div
            className="absolute top-1/4 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[600px] md:w-[1100px] md:h-[800px]"
            animate={{
              scale: [1, 1.02, 1],
      ...
      >
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            {["WhatsApp Integration", "Setup in 5 minutes", "AI-Powered"].map((item, i) => (
              <motion.span
                key={item}
