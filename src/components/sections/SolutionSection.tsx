...
const benefits = ["Never miss a follow-up window", "AI writes personalized messages", "WhatsApp-first automation", "Real-time lead scoring"];
const capabilities = [{
  icon: Brain,
  label: "AI Messages",
  description: "Natural, personalized"
}, {
  icon: MessageCircle,
  label: "WhatsApp",
        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-20 items-center">
            ...
            <div className="relative">
              ...
              <div className="bg-card border border-border rounded-2xl p-8 shadow-xl">
                ...
                <div className="grid grid-cols-2 gap-3">
                  {capabilities.map((item, index) => <motion.div key={item.label} initial={{
                  opacity: 0,
                  y: 15
                }} animate={isInView ? {
                  opacity: 1,
          ...
          delay: 0.2
            ...
            <p className="text-lg text-muted-foreground mb-8 leading-relaxed">
              Follow IQ automates your entire follow-up process with AI-powered messaging that feels personal. Connect with leads on WhatsApp where they actually respond.
            </p>
