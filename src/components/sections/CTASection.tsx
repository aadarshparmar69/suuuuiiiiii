        ...
        opacity
          ...
          ease: [0.25, 0.1, 0.25, 1]
            ...
            <div className="absolute inset-0 overflow-hidden">
              <motion.div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/3 w-[700px] h-[500px] bg-primary/8 rounded-full blur-[120px]" animate={{
              scale: [1, 1.1, 1],
              opacity: [0.6, 0.8, 0.6]
            }} transition={{
              duration: 8,
            ...
            <div className="relative z-10">
              ...
              delay: 0.7
                ...
                {["WhatsApp Integration", "AI-Powered Follow-ups", "Setup in 5 minutes"].map((item, i) => <motion.span key={item} initial={{
                opacity: 0,
                y: 10
              }} animate={isInView ? {
                opacity: 1,
