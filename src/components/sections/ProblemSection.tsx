...
const problems = [
  {
    icon: TrendingDown,
    stat: "80%",
    title: "of leads need 5+ follow-ups to close",
...
const AnimatedCounter = ({ value, isInView, delay = 0 }: AnimatedCounterProps) => {
          ...
          {problems.map((problem, index) => (
            ...
            >
              ...
              >
                ...
                {/* Stat */}
                <motion.div
                  className="text-5xl lg:text-6xl font-display font-bold text-accent mb-5"
                  initial={{ scale: 0.9 }}
                ...
                <motion.h3
                  ...
                  animate={isInView ? { opacity: 1, y: 0 } : {}}
                  transition={{ duration: 0.5, delay: 0.6 + index * 0.15, ease: easings.smooth }}
