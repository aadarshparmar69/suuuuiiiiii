...
const plans = [
  {
    name: "Starter",
    description: "Perfect for solopreneurs and small teams getting started with follow-up automation.",
    monthlyPrice: 49,
    yearlyPrice: 39,
    features: [
      ...
      { name: "Basic follow-up sequences", included: true },
  ...
  {
    name: "Professional",
    description: "For growing teams that need more power, flexibility, and collaboration.",
    monthlyPrice: 99,
    yearlyPrice: 79,
    popular: true,
    features: [
      { name: "Up to 5,000 leads", included: true },
      { name: "10,000 WhatsApp messages/mo", included: true },
      { name: "Advanced AI personalization", included: true },
      { name: "Unlimited sequences", included: true },
  ...
  {
    name: "Enterprise",
    description: "For large teams with custom requirements and dedicated support needs.",
    monthlyPrice: 249,
    yearlyPrice: 199,
    features: [
